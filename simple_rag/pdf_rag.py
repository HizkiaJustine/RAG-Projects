...
class SimpleModelSelector:
    ...
    def __init__(self):
        ...
        self.llm_models = {"gemini": "Gemini 3.5 Flash", "ollama": "Llama3.2"}
...
class SimpleRAGSystem:
    def __init__(self, embedding_model="gemini", llm_model="gemini"):
        self.embedding_model = embedding_model
        self.llm_model = llm_model

        # Initialize ChromaDB
        self.db = chromadb.PersistentClient(path="RAG-Projects/simple_rag/chroma_db")
